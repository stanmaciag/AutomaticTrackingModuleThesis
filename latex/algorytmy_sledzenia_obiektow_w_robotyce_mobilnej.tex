...
\begin{figure}[!htb]
	...
	\end{center}	
	\longcaptionsource{Przykłady działania metody Mean Shift}{Kolejne iteracje oznaczono estymacje położenia maksimum lokalnego funkcji gęstości oznaczono symbolem "*", okno w położeniu początkowym oznaczono okręgiem}{\cite{Comaniciu1999}}
\label{fig:Mean_Shift_przyklad}
\end{figure}

\subsection{Algorytm Mean Shift w śledzeniu obiektów}
