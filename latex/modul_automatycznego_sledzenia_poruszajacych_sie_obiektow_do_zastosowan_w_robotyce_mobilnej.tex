...
\include{wstep}
\include{zagadnienia_z_dziedziny_cyfrowego_przetwarzania_obrazow}
\include{zagadnienia_z_dziedziny_teorii_sterowania}
%\include{wykrywanie_poruszajacych_sie_obiektow_w_sekwencjach_obrazow}
\include{sledzenie_obiektow_w_sekwencjach_obrazow}
%\include{sterowanie_nadazne}
