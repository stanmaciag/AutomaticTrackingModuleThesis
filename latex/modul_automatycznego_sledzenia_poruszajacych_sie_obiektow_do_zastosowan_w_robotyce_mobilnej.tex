...
%\include{Wstep}
%\include{Pojazdy_UAV_i_systemy_AVS}
%\include{Architektura_systemu_AVS}
%\include{Metody_wykrywania_i_sledzenia_poruszajacych_sie_obiektow}
%\include{Ogolny_zarys_architektury_systemu_sterowania}
\include{analiza_literaturowa_zagadnienia}
