...
\includepdf[pages=-]{oswiadczenie_2.pdf}
\includepdf[pages=-]{prawa.pdf}
\includepdf[pages=-]{plan.pdf}
\includepdf[pages=-]{streszczenie.pdf}
...
\include{programowa_realizacja_modulow}
\include{modul_lucas_kanade}
\include{modul_camshift}
