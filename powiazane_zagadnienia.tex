...
\todo{Rekursywny filtr Bayesa}
\todo{Ukryty łańcuch Markowa}
\todo{SURF}

\section{Ekstrakcja i deskrypcja cech obrazu}
\label{sec:Ekstrakcja_i_deskrypcja_cech_obrazu}

\todo{Uaktualnić według \cite{Maggio2011}}
...
\todo{Przenieść opis SIFT do \ref{cha:Algorymty_sledzenia_obiektow_w_robotyce_mobilnej}}
